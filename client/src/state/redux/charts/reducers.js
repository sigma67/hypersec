...
const transactionSizeReducer = (state = initialState, action) => {
	switch (action.type) {
		case types.TRANSACTION_CHART_SIZE: {
			return {
				rows: action.payload.transactionSize.rows,
				loaded: true,
				errors: action.errors
			};
		}
...
const interBlockTimeReducer = (state = initialState, action) => {
	switch (action.type) {
		case types.INTERBLOCK_TIME_CHART: {
			return {
				rows: action.payload.interBlockTime.rows,
				loaded: true,
				errors: action.errors
			};
		}
...
const reducer = combineReducers({
	...
	transactionSize: transactionSizeReducer,
	interblockTime: interBlockTimeReducer,
