...
const getTransactionSize = transactionSize => ({
	type: types.TRANSACTION_CHART_SIZE,
	payload: { transactionSize }
});

const getInterblockTime = interblockTime => ({
	type: types.INTERBLOCK_TIME_CHART,
	payload: { interblockTime }
});
