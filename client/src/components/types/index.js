...
export const getTransactionSizeType = func;
export const getInterblockTimeType = func;
...
export const transactionSizeType = arrayOf(
	shape({
		count: string,
		datetime: string
	})
...
export const interblockTimeType = arrayOf(
	shape({
		datetime: string
	})
);
