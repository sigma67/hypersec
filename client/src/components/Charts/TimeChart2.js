...
export const TimeChart2 = ({ chartData, classes }) => (
	<div>
		<Card>
			<CardContent className={classes.content}>
				<ResponsiveContainer width="100%" height={255}>
					<ScatterChart>
						...
						<ReferenceLine y={3} label="Average 24h" stroke="red" />
					</ScatterChart>
				</ResponsiveContainer>
			</CardContent>
		</Card>
...
TimeChart2.propTypes = {
	chartData: chartDataType.isRequired
};

export default withStyles(styles)(TimeChart2);
